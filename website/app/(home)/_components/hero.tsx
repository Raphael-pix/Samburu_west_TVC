        ...
        <div className="container mx-auto px-6 py-16 lg:px-16 lg:py-32">
          <div className="transform transition-all duration-500 hover:translate-y-[-10px]">
            ...
            <p className="mb-8 max-w-2xl text-base lg:text-lg ">
              Take the first step toward a brighter future! Join our school and
              gain the skills, knowledge, and hands-on experience you need to
              succeed. Apply today and start your journey to excellence!
            </p>
            <button
